            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-6 bg-white">
                <div class="d-flex align-items-center px-4 px-lg-5 h-100 bg-dash-dark-2">
                            ...
                            //Registration Form
                            <form class="register-form py-5 w-100" method="POST" action="{{ route('register.custom') }}"">
                                @csrf
                                <div class="input-material-group mb-3">
                                <input class="input-material" type="text" name="username" placeholder="Username" required data-validate-field="registerUsername">
                                ...
                                <input class="input-material" type="password" name="pass" placeholder="Password" required data-validate-field="registerPassword">
                                ...
                                <div class="input-material-group mb-4">
                                <input class="input-material" type="password" name="confirm_password" placeholder="Confirm Password" required data-validate-field="registerPassword">
