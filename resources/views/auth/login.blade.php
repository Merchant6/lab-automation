                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login.custom') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('user') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('pass') is-invalid @enderror" name="pass" required >
